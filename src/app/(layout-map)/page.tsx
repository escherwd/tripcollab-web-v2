      ...
      `}</style>
        ...
        <div className="flex pt-[10%] flex-col items-start justify-center w-full max-w-xl gap-12 relative">
          ...
          <div className="w-full">
            <div className="tc-small-heading tc-small-heading-white">
              Upcoming Trips
            </div>
            <div className="grid grid-cols-3 gap-2 w-full items-stretch">
              ...
              <Link
                href="/new"
                className="bg-white/15 hover:bg-white/20 transition-colors flex items-center justify-center rounded"
              >
