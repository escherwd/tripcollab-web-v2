...
export const renderFeatureToMarker = (feature: GeoJSONFeature, e: MapMouseEvent) => {
    ...
    if (feature.geometry.type === "Point" && isPoi) {
        coordinate.lat = feature.geometry.coordinates[1] ?? coordinate.lat;
        coordinate.lng = feature.geometry.coordinates[0] ?? coordinate.lng;
      }
